...
if ( window.__electron_ipc_plus__ ) {
  console.warn(`A different version of electron-ipc-plus already running in the process: ${window.__electron_ipc_plus__}, make sure your dependencies use the same version of electron-ipc-plus.`);
}
